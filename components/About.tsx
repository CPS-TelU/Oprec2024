...
const About = () => {
  ...
  return (
    <div className="hero min-h-screen " id="about">
      <div className="hero-content flex-col xl:flex-row lg:gap-12" ref={ref} style={{ transform: inView ? "translateX(0)" : "translateX(-100%)",
        ...
        >
          <h1 className="flex justify-center text-[30px] font-viga font-bold  md:text-[40px]">
            CYBER RECRUITMENT
          </h1>
